...
def test_scenex_controller_publishes_tracks_camera_and_metrics(wait) -> None:
    ...
    try:
        ...
        metrics = controller.stream.performance.target
        assert metrics.submitted_bytes >= fine.nbytes
